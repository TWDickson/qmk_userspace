 ...
 * behaves the same way, and the freed key pairs Mute with Play across the two
...
[_QWERTY] = LAYOUT(
  ...
  LSFT_T(KC_LBRC),  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,   KC_MPLY,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_RBRC),
